...
import { Plugin as B, PluginKey as N, TextSelection as O, NodeSelection as ce, Selection as Me, EditorState as Mo } from "prosemirror-state";
...
import { columnResizing as Fo, tableEditing as Go, goToNextCell as tt, TableView as $o, CellSelection as Fe, TableMap as ot } from "prosemirror-tables";
import Wo from "@tiptap/extension-collaboration";
import Ko from "@tiptap/extension-collaboration-cursor";
import { Gapcursor as qo } from "@tiptap/extension-gapcursor";
import { HardBreak as Xo } from "@tiptap/extension-hard-break";
import { History as Zo } from "@tiptap/extension-history";
import { Link as Jo } from "@tiptap/extension-link";
import { Text as Yo } from "@tiptap/extension-text";
import * as Ct from "prosemirror-view";
import { Decoration as oe, DecorationSet as ie, EditorView as Qo } from "prosemirror-view";
...
function gi(e, t = JSON.stringify) {
  const o = {};
  return e.filter((i) => {
    const n = t(i);
    ...
    return [
      new B({
        ...
        appendTransaction: (o, i, n) => {
          ...
          if (!r || a)
            return;
          const { tr: s } = n, { types: l, attributeName: c, generateID: d } = this.options, u = _o(
            i.doc,
            o
          ), { mapping: h } = u;
          if (yo(u).forEach(({ newRange: m }) => {
            const g = vo(
              n.doc,
              m,
              (C) => l.includes(C.type.name)
            ), b = g.map(({ node: C }) => C.attrs[c]).filter((C) => C !== null), k = bi(b);
...
function H(e, t, o) {
  const i = [];
  for (const n of e)
    typeof n == "string" ? i.push(...He(n, t, o)) : St(n) ? i.push(...ki(n, t, o)) : de(n) ? i.push(...He([n], t, o)) : i.push(
      Bt(n, t, o)
    );
  return i;
}
...
function _i(e, t, o, i, n, r, a) {
  ...
  if (!o.props) {
    ...
    for (const [E, w] of Object.entries(
      ...
      w.default !== void 0 && (c[E] = w.default);
  }
  ...
  if (h.dom.classList.contains("bn-block-content")) {
    ...
    Tt(h.dom.firstChild), f.append(...h.dom.childNodes);
  } else
    f.append(h.dom);
  ...
  if (n.has(o.type) ? m = "OL" : r.has(o.type) && (m = "UL"), m) {
    if (((k = e.lastChild) == null ? void 0 : k.nodeName) !== m) {
      const w = s.createElement(m);
      m === "OL" && (c != null && c.start) && (c == null ? void 0 : c.start) !== 1 && w.setAttribute("start", c.start + ""), e.append(w);
    }
...
const Ci = () => typeof navigator < "u" && (/Mac/.test(navigator.platform) || /AppleWebKit/.test(navigator.userAgent) && /Mobile\/\w+/.test(navigator.userAgent));
function V(e, t = "Ctrl") {
  return Ci() ? e.replace("Mod", "⌘") : e.replace("Mod", t);
}
function G(...e) {
  return e.filter((t) => t).join(" ");
}
const rs = () => /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
function R(e, t, o, i) {
...
function be(e, t, o, i, n = !1, r) {
  ...
  for (const [s, l] of Object.entries(o)) {
    const d = i[s].default;
    !Pt.includes(s) && l !== d && a.setAttribute(ye(s), l);
  }
...
function me(e, t) {
  const o = $({
    ...
    addNodeView() {
      return ({ getPos: i }) => {
        var c;
        const n = this.options.editor, r = Ei(
          i,
          n,
          this.editor,
          e.type
        ...
        return e.isSelectable === !1 && Si(l, this.editor), l;
      };
    }
  });
  if (o.name !== e.type)
...
function at(e, t, o, i) {
  return e.dom.setAttribute("data-inline-content-type", t), Object.entries(o).filter(([n, r]) => {
    const a = i[n];
    return r !== a.default;
  }).map(([n, r]) => [ye(n), r]).forEach(([n, r]) => e.dom.setAttribute(n, r)), e.contentDOM !== void 0 && e.contentDOM.setAttribute("data-editable", ""), e;
}
function Ti(e) {
  return {
    Backspace: ({ editor: t }) => {
...
}, Di = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 8L9.00319 2H19.9978C20.5513 2 21 2.45531 21 2.9918V21.0082C21 21.556 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5501 3 20.9932V8ZM10 4V9H5V20H19V4H10Z"></path></svg>', Hi = (e) => {
  const t = document.createElement("div");
  t.className = "bn-file-name-with-icon";
  const o = document.createElement("div");
  o.className = "bn-file-icon", o.innerHTML = Di, t.appendChild(o);
...
}, st = (e) => ({ url: e.src || void 0 }), Ui = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M2 16.0001H5.88889L11.1834 20.3319C11.2727 20.405 11.3846 20.4449 11.5 20.4449C11.7761 20.4449 12 20.2211 12 19.9449V4.05519C12 3.93977 11.9601 3.8279 11.887 3.73857C11.7121 3.52485 11.3971 3.49335 11.1834 3.66821L5.88889 8.00007H2C1.44772 8.00007 1 8.44778 1 9.00007V15.0001C1 15.5524 1.44772 16.0001 2 16.0001ZM23 12C23 15.292 21.5539 18.2463 19.2622 20.2622L17.8445 18.8444C19.7758 17.1937 21 14.7398 21 12C21 9.26016 19.7758 6.80629 17.8445 5.15557L19.2622 3.73779C21.5539 5.75368 23 8.70795 23 12ZM18 12C18 10.0883 17.106 8.38548 15.7133 7.28673L14.2842 8.71584C15.3213 9.43855 16 10.64 16 12C16 13.36 15.3213 14.5614 14.2842 15.2841L15.7133 16.7132C17.106 15.6145 18 13.9116 18 12Z"></path></svg>', Oi = {
...
], lt = Symbol.for("blocknote.shikiParser"), Ie = Symbol.for(
      ...
      new te({
        ...
        handler: ({ state: t, range: o, match: i }) => {
          ...
          if (!n.node(-1).canReplaceWith(
            ...
            return null;
          t.tr.delete(o.from, o.to).setBlockType(o.from, o.from, this.type, a).setSelection(O.create(t.tr.doc, o.from));
        }
      })
    ];
  },
...
}), en = K(Qi, "string"), dt = (e) => ({ url: e.src || void 0 }), tn = {
  backgroundColor: x.backgroundColor,
  // File name.
  name: {
    default: ""
...
const zt = {
  ...
  Mn,
  Tn
), Ln = 35, Kt = 120, cs = 31, An = L.create({
...
function I(e, t) {
  return e in t.schema.blockSchema && t.schema.blockSchema[e] === Gn[e];
}
function Wn(e, t) {
  return e in t.schema.inlineContentSchema && t.schema.inlineContentSchema[e] === $n[e];
}
function Kn(e, t, o) {
...
function T(e, t) {
  ...
  let i;
  return Array.isArray(o.content) && (o.content.length === 1 && de(o.content[0]) && o.content[0].type === "text" && o.content[0].text === "/" || o.content.length === 0) ? (i = e.updateBlock(o, t), e.setTextCursorPosition(i)) : (i = e.insertBlocks([t], o, "after")[0], e.setTextCursorPosition(e.getTextCursorPosition().nextBlock)), Xn(e), i;
}
function gs(e) {
  const t = [];
...
function fr(e, t, o) {
  ...
  e._tiptapEditor.dispatch(
    e._tiptapEditor.state.tr.setSelection(
      O.create(e._tiptapEditor.state.doc, h, f)
    )
  );
}
let Y;
...
function Xe(e) {
  ...
  return t.unified.unified().use(t.rehypeParse.default, { fragment: !0 }).use(gr).use(br).use(t.rehypeRemark.default).use(t.remarkGfm.default).use(t.remarkStringify.default, {
    handlers: { text: (i) => i.value }
  }).processSync(e).value;
}
async function kr(e, t, o, i) {
  await qe();
...
function vr(e) {
  e.querySelectorAll("li > ul, li > ol").forEach((t) => {
    const o = _r(t), i = t.parentElement, n = Array.from(i.childNodes).slice(
      o + 1
    );
  ...
  for (let s = 0; s < n.length; s++) {
    ...
    for (const d of r)
      for (const u of d.fileBlockAccept || []) {
        ...
        if (f && (!h && f.type && Br(n[s].type, u) || h && Sr(
          "." + f.name.split(".").pop(),
          u
        ))) {
          l = d.type;
...
function co(e, t) {
  ...
  ).dom.innerHTML, i = e.state.selection.content().content, n = Lr(
    e,
    i,
    t
  ), r = Xe(n);
...
const ft = (e, t) => {
  ...
  return t;
}, Or = (e, t) => e.isBlockContainer && e.blockContent.node.type.spec.content === "inline*" && e.blockContent.node.childCount > 0 && t.isBlockContainer && t.blockContent.node.type.spec.content === "inline*", Rr = (e, t, o, i) => {
  if (!i.isBlockContainer)
    throw new Error(
...
class zr {
  constructor(t, o, i) {
    ...
    p(this, "scrollHandler", () => {
      var t;
      this.linkMark !== void 0 && (t = this.state) != null && t.show && (this.state.referencePos = je(
        this.pmView,
...
const Fr = new N("LinkToolbarPlugin");
class Gr extends ne {
  constructor(o) {
    super();
    p(this, "view");
...
const $r = [
  ...
  "cid",
  "xmpp"
], Wr = "https", Kr = new N("node-selection-keyboard");
class qr {
  constructor() {
    p(this, "plugin");
    this.plugin = new B({
...
const Xr = new N("blocknote-placeholder");
class Zr {
  constructor(t, o) {
    p(this, "plugin");
    this.plugin = new B({
...
const bt = new N("previous-blocks"), Jr = {
  // Numbered List Items
  index: "index",
  // Headings
  level: "level",
...
function ea(e, t, o) {
  ...
  if (r != null) {
    const a = i.state.selection, s = i.state.doc, { from: l, to: c } = Qr(a, s), d = l <= r && r < c, u = a.$anchor.node() !== a.$head.node() || a instanceof Q;
    d && u ? (i.dispatch(
      i.state.tr.setSelection(Q.create(s, l, c))
    ), kt(i, l, c)) : (i.dispatch(
      i.state.tr.setSelection(ce.create(i.state.doc, r))
    ), kt(i, r));
    const h = i.state.selection.content(), f = o.pmSchema, m = Ct.__serializeForClipboard(
      i,
      h
    ).dom.innerHTML, g = Ee(f, o), b = lo(h.content, o.schema), k = g.exportBlocks(b, {}), C = Xe(k);
  ...
  constructor(t, o, i, n) {
    ...
    p(this, "onDragStart", (t) => {
      ...
      if (!this.pmView.dragging) {
        ...
        const n = document.createElement("div");
        n.innerHTML = i;
        const a = vt.fromSchema(this.pmView.state.schema).parse(n, {
...
class na extends ne {
  constructor(o, i) {
    ...
    p(this, "blockDragStart", (o, i) => {
      this.view && (this.view.isDragOrigin = !0), ea(o, i, this.editor);
    });
    /**
     * Handles drag & drop events for blocks.
     */
...
const ra = Eo((e) => e.type.name === "blockContainer");
class aa {
  constructor(t, o) {
    p(this, "state");
    p(this, "emitUpdate");
...
class ua {
  constructor(t, o, i) {
    ...
    p(this, "mouseMoveHandler", (t) => {
      ...
      if (Kn("table", s, this.editor) && (this.tablePos = a.posBeforeNode + 1, r = s), !r)
        return;
      this.tableId = n.id;
    ...
    p(this, "dragOverHandler", (t) => {
      ...
      if (((h = this.state) == null ? void 0 : h.draggingState) === void 0)
        return;
      t.preventDefault(), t.dataTransfer.dropEffect = "move", ca(
  ...
  constructor(o) {
    ...
    p(this, "dragEnd", () => {
      ...
      if (this.view.state.draggingState = void 0, this.view.emitUpdate(), this.editor.dispatch(
        ...
        throw new Error("Editor view not initialized.");
      la(this.editor.prosemirrorView.root);
    });
    /**
...
const ha = L.create({
  ...
  for (const n of o)
    t[n.name] = n;
  t.formattingToolbar = new Ur(
    e.editor
  ), t.linkToolbar = new Gr(e.editor), t.sideMenu = new na(
    e.editor,
    e.sideMenuDetection
  ), t.suggestionMenus = new sa(e.editor), t.filePanel = new jr(e.editor), t.placeholder = new Zr(e.editor, e.placeholders), (e.animations ?? !0) && (t.animations = new Yr()), e.tableHandles && (t.tableHandles = new pa(e.editor)), t.dropCursor = {
    plugin: e.dropCursor({
      width: 5,
      color: "#ddeeff",
      editor: e.editor
    })
  }, t.nodeSelectionKeyboard = new qr();
  ...
  const t = [
    ...
    ...e.trailingBlock === void 0 || e.trailingBlock ? [fa] : []
  ];
  if (e.collaboration) {
    t.push(
      Wo.configure({
...
function Ca(e, t) {
  ...
  if (o = xa(o, t.state.schema), !Ea(o, t))
  ...
  for (let i = 0; i < o.childCount; i++)
    if (o.child(i).type.spec.group === "blockContent") {
      ...
      if (i + 1 < o.childCount && o.child(i + 1).type.name === "blockGroup") {
        ...
        (a.type.name === "bulletListItem" || a.type.name === "numberedListItem" || a.type.name === "checkListItem") && (n.push(o.child(i + 1)), o = wa(o, i + 1));
      }
...
const we = class we extends So {
  constructor(o, i) {
    ...
    n.nodes.doc.createAndFill = (...l) => {
      ...
      return d.content[0].content[0].attrs.id = "initialBlockId", r = ko.fromJSON(n, d), r;
    };
    let s;
    try {
...
class mo {
  constructor(t) {
    ...
    if (this.schema = i.schema, this.blockImplementations = i.schema.blockSpecs, this.inlineContentImplementations = i.schema.inlineContentSpecs, this.styleImplementations = i.schema.styleSpecs, this.extensions = ya({
      editor: this,
      ...
      dropCursor: this.options.dropCursor ?? ei,
  ...
  async blocksToFullHTML(t) {
    return xi(this.pmSchema, this).serializeBlocks(t, {});
  }
  /**
  ...
  async blocksToMarkdownLossy(t = this.document) {
    return kr(t, this.pmSchema, this, {});
  }
  /**
...
async function Ss(e, t) {
  if (!Wn("text", e))
    return [];
  if (!_e) {
    _e = import("@emoji-mart/data"), Pe = await import("emoji-mart");
    const n = (await _e).default;
    await Pe.init({ data: n });
  }
...
function Ba(e) {
  e.id || (e.id = ue.options.generateID()), e.children && Ta(e.children);
}
function Ta(e) {
  for (const t of e)
    Ba(t);
...
export {
  ...
  xs as COLORS_DARK_MODE_DEFAULT,
  ws as COLORS_DEFAULT,
  $i as CodeBlock,
  Wr as DEFAULT_LINK_PROTOCOL,
  cs as EMPTY_CELL_HEIGHT,
  Kt as EMPTY_CELL_WIDTH,
  Cs as Exporter,
  Ui as FILE_AUDIO_ICON_SVG,
  Di as FILE_ICON_SVG,
  pn as FILE_IMAGE_ICON_SVG,
  Hn as FILE_VIDEO_ICON_SVG,
  sn as FileBlock,
  jr as FilePanelProsemirrorPlugin,
  Nr as FilePanelView,
  Ur as FormattingToolbarProsemirrorPlugin,
  Dr as FormattingToolbarView,
  ao as HTMLToBlocks,
  kn as ImageBlock,
  Gr as LinkToolbarProsemirrorPlugin,
  Zi as PageBreak,
  na as SideMenuProsemirrorPlugin,
  oa as SideMenuView,
  sa as SuggestionMenuProseMirrorPlugin,
  pa as TableHandlesProsemirrorPlugin,
  ua as TableHandlesView,
  ue as UniqueID,
  D as UnreachableCaseError,
  $r as VALID_LINK_PROTOCOLS,
  Fn as VideoBlock,
  Ba as addIdsToBlock,
  Ta as addIdsToBlocks,
  at as addInlineContentAttributes,
  Ti as addInlineContentKeyboardShortcuts,
  Pi as addStyleAttributes,
  Si as applyNonSelectableBlockFix,
  ns as assertEmpty,
  Ri as audioBlockConfig,
  zi as audioParse,
  Oi as audioPropSchema,
  Vi as audioRender,
  Fi as audioToExternalHTML,
  Z as blockToNode,
  kr as blocksToMarkdown,
  ye as camelToDataKebab,
  fs as checkBlockHasDefaultProp,
  Kn as checkBlockIsDefaultType,
  ps as checkBlockIsFileBlock,
  ms as checkBlockIsFileBlockWithPlaceholder,
  hs as checkBlockIsFileBlockWithPreview,
  qn as checkBlockTypeHasDefaultProp,
  I as checkDefaultBlockTypeInSchema,
  Wn as checkDefaultInlineContentTypeInSchema,
  Zn as checkPageBreakBlocksInSchema,
  Xe as cleanHTMLToMarkdown,
  Bs as combineByGroup,
  Se as contentNodeToInlineContent,
  Dt as contentNodeToTableContent,
  ji as createAddFileButton,
  ...
  Ii as createInlineContentSpecFromTipTapNode,
  Nt as createInternalBlockSpec,
  xi as createInternalHTMLSerializer,
  Mi as createInternalInlineContentSpec,
  ...
  ls as createStyleSpec,
  K as createStyleSpecFromTipTapMark,
  vs as createSuggestionMenu,
  ds as customizeCodeBlock,
  Gn as defaultBlockSchema,
  qt as defaultBlockSpecs,
  rt as defaultBlockToHTML,
  Oe as defaultCodeBlockPropSchema,
  $n as defaultInlineContentSchema,
  Zt as defaultInlineContentSpecs,
  x as defaultProps,
  us as defaultStyleSchema,
  Xt as defaultStyleSpecs,
  Y as esmDependencies,
  on as fileBlockConfig,
  rn as fileParse,
  tn as filePropSchema,
  nn as fileRender,
  an as fileToExternalHTML,
  as as filenameFromURL,
  bs as filterSuggestionItems,
  V as formatKeyboardShortcut,
  Hr as formattingToolbarPluginKey,
  Ei as getBlockFromPos,
  F as getBlockInfo,
  pe as getBlockInfoFromResolvedPos,
  _ as getBlockInfoFromSelection,
  Ge as getBlockInfoWithManualOffset,
  ya as getBlockNoteExtensions,
  jt as getBlockSchemaFromSpecs,
  Ss as getDefaultEmojiPickerItems,
  gs as getDefaultSlashMenuItems,
  Li as getInlineContentParseRules,
  Ht as getInlineContentSchemaFromSpecs,
  z as getNearestBlockPos,
  A as getNodeById,
  _s as getPageBreakSlashMenuItems,
  Bi as getParseRules,
  Ni as getStyleParseRules,
  Ot as getStyleSchemaFromSpecs,
  mn as imageBlockConfig,
  gn as imageParse,
  hn as imagePropSchema,
  fn as imageRender,
  bn as imageToExternalHTML,
